...
<body>
	...
	<div id="all">
		<div id="title">
			<?= date("m 月 d日 l") ?> | 今日瀏覽: <?= $Total->find(['date' => date("Y-m-d")])['total'] ?> | 累積瀏覽: <?= $Total->sum('total') ?> 
		...
		<div class="hal" id="lef">
			...
			<div class="hal" id="main">
				<div>
<marquee  style="width:80%; display:inline-block;">民眾踴躍投稿電子報，讓電子報成為大家相互交流、分享的園地!詳見最新文章</marquee>
