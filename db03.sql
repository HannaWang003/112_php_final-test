...
INSERT INTO `news` (`id`, `title`, `news`, `type`, `good`, `sh`) VALUES
...
(1, '你最常做什麼運動來促進健康體能呢?', 0, 4, 1),
(2, '健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', 1, 1, 1),
(3, '仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。', 1, 2, 1),
(4, '球類運動、游泳、跳舞、騎腳踏車等加強心肺功能的運動。', 1, 0, 1),
(5, '舉重鍛鍊、彈力帶、啞鈴等運用輔助器材鍛鍊肌耐力的運動。', 1, 1, 1);
...
(1, 'acc', 'pw', 'email'),
(4, 'admin', '1234', 'admin@labor.gov.tw'),
(7, 'mem01', 'mem01', 'mem01@labor.gov.tw'),
