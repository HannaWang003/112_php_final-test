...
<div style="display:flex;margin-left:1px;">
    <div class="item active" data-list="1">健康新知</div>
    <div class="item" data-list="2">菸害防治</div>
    <div class="item" data-list="3">癌症防治</div>
    <div class="item" data-list="4">慢性病防治</div>
</div>
<div id="sec1" class="list">
    <h2>健康新知</h2>
    <pre>
...
<div id="sec2" class="list" style="display:none">
    <h2>菸害防治</h2>
    <pre>
    菸害防治法規
...
<div id="sec3" class="list" style="display:none">
    <h2>癌症防治</h2>
    <pre>
    降低罹癌風險 建構健康生活型態
...
<div id="sec4" class="list" style="display:none">
    <h2>慢性病防治</h2>
    <pre>
    長期憋尿 泌尿系統問題多 
資料來源：中央健康保險局雙月刊第98期
